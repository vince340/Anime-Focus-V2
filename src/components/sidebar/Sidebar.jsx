          ...
          <div className="flex gap-x-7 w-full py-3 justify-center px-auto mt-8 bg-black/10 max-[575px]:gap-x-4 lg:hidden">
            {[
              ...
              >
                <FontAwesomeIcon
                  icon={item.icon}
                  className="text-[#ff3d7f] text-xl font-bold max-[575px]:text-[15px]"
                />
          ...
          <ul className="text-white mt-8 w-full">
            {[
              ...
              >
                <Link
                  to={item.path}
                  className="px-4 hover:text-[#FFDD95] hover:cursor-pointer w-fit line-clamp-1"
                >
                  {item.name}
                </Link>
              </li>
