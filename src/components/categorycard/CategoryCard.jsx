    ...
    return (
      <div className={`w-full ${className}`}>
        <div className="flex items-center justify-between">
          <h1 className="font-bold text-2xl text-[#FFDD95] max-[478px]:text-[18px] capitalize">
            {label}
          </h1>
          {showViewMore && (
            <Link
            ...
            >
              {itemsToRender.firstRow.map((item, index) => (
                ...
                >
                  ...
                  <Link
                    to={`/${item.id}`}
                    className="text-white font-semibold mt-1 item-title hover:text-[#FFDD95] hover:cursor-pointer line-clamp-1"
                  >
