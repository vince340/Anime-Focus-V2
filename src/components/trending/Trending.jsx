...
const Trending = ({ trending }) => {
  ...
  return (
    <div className="mt-6 max-[1200px]:px-4 max-md:px-0">
      <h1 className="text-[#FFDD95] text-2xl font-bold max-md:pl-4">
        Trending
      </h1>
            ...
            trending.map((item, idx) => (
              ...
              >
                <div className="w-full h-auto pb-[115%] relative inline-block overflow-hidden max-[575px]:pb-[150%]">
                  <div className="absolute left-0 top-0 bottom-0 overflow-hidden w-[40px] text-center font-semibold bg-[#242328] max-[575px]:top-0 max-[575px]:h-[30px] max-[575px]:z-[9] max-[575px]:bg-white">
